        ...
        <div className="relative w-full flex flex-col items-center min-h-[100dvh]">
          ...
          <div className="container mx-auto flex flex-col items-center justify-start relative z-10">
            <div className="relative w-full h-[100dvh]">
              <div
                className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 transition-none rounded-2xl"
                style={{
                  width: `${mediaWidth}px`,
              ...
              <div
                className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex items-center justify-center text-center gap-4 w-full px-4 pointer-events-none transition-none flex-col ${
